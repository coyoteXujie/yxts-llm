...
- 已加入世界地图到局部区域、局部区域到商铺内景的第一版转入转出流程。
- 局部区域已按城池、镇子、门派、野外地貌生成差异化道路、水系、街区、庭院、区域水墨氛围层和 2.5D 场景小件，并加入每日刷新资源点。
- 当前有 99 个 NPC、10 个任务、22 个物品、41 个武学图标和 73 张区域背景占位图。
- NPC 参考级地图 sprite、组件化 NPC 回退 sprite、对话头像、玩家门派 sprite、物品图标、武学图标、80 张 96px 手绘多变体地图瓦片、19 张 2.5D 地图道具 PNG、局部地图模板和 UI 资源均已接入 Godot 工程。
- 玩法竖切包含移动、区域进入、商铺内景、交谈、任务、商店、背包、修炼、战斗、世界地图、快速旅行、存档读档、基础时间天气和地域主题动态氛围。
