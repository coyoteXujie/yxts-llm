...
func _run() -> void:
	...
	_check(str(LOCAL_AREA_SCRIPT.STAGE_MIDGROUND_LAYER_TEXTURES.get("qinghe", "")).ends_with("qinghe_shopfront_layer_v2.png"), "清河镇应映射专属横版店铺中景层")
	var qinghe_midground_layer := GameData.load_texture(str(LOCAL_AREA_SCRIPT.STAGE_MIDGROUND_LAYER_TEXTURES.get("qinghe", "")), true)
